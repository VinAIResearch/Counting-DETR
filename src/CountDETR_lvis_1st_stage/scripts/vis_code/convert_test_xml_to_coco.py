...
def convert_xmls_to_cocojson(annotation_paths: List[str], output_jsonpath: str, extract_num_from_imgid: bool = True):
...
def main():
    ...
    convert_xmls_to_cocojson(
        annotation_paths=ann_paths, output_jsonpath=args.output,
    )
