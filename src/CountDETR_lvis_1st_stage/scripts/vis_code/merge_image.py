...
parser.add_argument("-i1", "--detection_folder", type=str, default='./debug_image/det_keep_score_text/', )
parser.add_argument("-i2", "--heatmap_folder", type=str,default="./debug_image/counting_keep_score_text/", )
parser.add_argument("-o", "--output_folder", type=str,default="./debug_image/combined_text/", )
