...
class Transformer(nn.Module):
    ...
    def forward(self, srcs, masks, points=None):
        ...
        tgt = self.modify_pattern.weight.reshape(1, self.num_pattern, 1, c).repeat(bs, 1, self.num_position, 1).reshape(
        ...
        outputs_xy = outputs_xywh[...,:2]; outputs_wh = outputs_xywh[...,2:]
